...
#: で slew しており、**学習の 2.1 分の 1**。手の値は物理角なので unit/s と
#: motor rad/s は同じ量 (Issue #159 B3a-04。以前は 1.70 unit/s と換算していた)。
#: 会場の速度設定は運営側が所有する。依頼値は実機ドライランで確認し、
#: `docs/handoff/venue_commands.md` の go-live gate に従う。
#:
